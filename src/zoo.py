...
4. ZooKeeper: questa classe rappresenta un guardiano dello zoo responsabile della gestione dello zoo. I guardiani dello zoo hanno un name, un surname, e un id. 
...
L'animale deve essere collocato in un recinto adeguato in base alle esigenze del suo habitat e se c'è ancora spazio nel recinto, ovvero se l'area del recinto è ancora sufficiente per ospitare questo animale.
...
class ZooKeeper:
    ...
    def add_animal(self, animal: Animal, fence: Fence):
        ...
        if animal.preferred_habitat != fence.habitat: 
            return "habitat animale diverso habitat fence"
        
        if fence.area < animal.height * animal.width:
            return "area recinto più piccola di area animale"
